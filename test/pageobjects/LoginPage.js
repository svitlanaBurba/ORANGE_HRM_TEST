...
class LoginPage extends Page {
    ...
    get credentialsTab () {
        return $('/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]');
    }
    ...
    async getCredentials() {
        ...
        const[allCredentials, username, password] = credentialsText.match(credentialsRegex);
